...
[![Скачать KIA 23.02 APK](https://img.shields.io/badge/%D0%A1%D0%BA%D0%B0%D1%87%D0%B0%D1%82%D1%8C-KIA%2023.02%20APK-17a673?style=for-the-badge&logo=android&logoColor=white)](https://github.com/mrglonin/kia/releases/download/v23.02-356/kia_356.apk)

- APK KIA: [kia_356.apk](https://github.com/mrglonin/kia/releases/download/v23.02-356/kia_356.apk)
...
- GitHub Release: [`v23.02-356`](https://github.com/mrglonin/kia/releases/tag/v23.02-356)
- Текущий публичный релиз: `23.02` / `356`

## Релиз

| Компонент | Версия | Файл | SHA-256 |
| --- | --- | --- | --- |
| KIA app | `23.02` / `356` | `updates/kia_356.apk`, 5.6 MB | `9277f39c2f7dcd1eacf112e6ee20b94dc3423a1a3b61413c3e1db58f459ae7ab` |
...
В `23.00` выбор стрелки был переведён на реальный порядок манёвров: ближайший micro/lane-манёвр показывается раньше удалённого кругового. В `23.01` исправлено отображение выбранной жёлтой ветки для 1/2/3/4 съезда с кругового. В `23.02` микроманёвр управляет только жёлтым знаком и серой дорогой, а дистанция и прогресс приборки непрерывно относятся к основному манёвру; transient `0` удерживает последний безопасный кадр. При обновлении достаточно установить только KIA `23.02`; Yandex mod `7.10-kia.20260723` менять не требуется.
...
5. Установить Yandex Navigator mod, если интеграция через Kia bridge настраивается впервые. При обновлении KIA до `23.02` переустанавливать уже имеющийся Yandex mod `7.10-kia.20260723` не нужно.
...
$ADB -s emulator-5554 install -r updates/kia_356.apk
